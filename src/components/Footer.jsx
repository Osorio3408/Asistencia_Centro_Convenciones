    ...
    <div>
      <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
        ...
        <div class="sm:flex text-center sm:items-center sm:justify-between ">
          <span class="text-sm text-center items-center justify-center text-gray-500 sm:text-center dark:text-gray-400">
            &copy; 2022 . All Rights Reserved.
          </span>
          <div class="flex text-center items-center justify-center mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              href="#"
