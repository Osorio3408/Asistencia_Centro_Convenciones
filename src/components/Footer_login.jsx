...
const Footer_login = () => {
  return (
    <>
      <footer class="w-full p-4 fixed bottom-0 text-center bg-sky-900 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-sky-900  border-t-white ">
